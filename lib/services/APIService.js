...
var apiKey = "eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJjMGNjOTZmMTllNzJiYTgxY2UxNWMxMWRkOWJkZjMxYiIsInN1YiI6IjY2NGNkYTI4YThhNThkY2I3YTZlYjIwNyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.bY82hbPJncqfBkEZaG4ZifQPcyUFrYLk-QpIyaKg6Oc";
var mockData = {
  page: 1,
  results: [{
    adult: false,
...
function getMovies() {
  ...
  var url = "".concat(URL_API, "/discover/movie");
  ...
  return fetch("".concat(url), {
    ...
    headers: {
      ...
      Authorization: "Bearer ".concat(apiKey) // Ejemplo de header de autorización
    }
    ...
    return data.results.map(function (movie) {
      return (0, _transformers.formatMovie)(movie);
    });
